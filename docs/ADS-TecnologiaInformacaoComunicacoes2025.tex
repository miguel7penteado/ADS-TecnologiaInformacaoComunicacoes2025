...
\includegraphics{images/np1/89-loja_virtual_com_produtos_carregados.jpg}
...
\includegraphics{images/np1/90-loja_virtual_meio_de_pagamento1.jpg}

Procure pelo menu ``Meio de Pagamento''

\includegraphics{images/np1/91-loja_virtual_meio_de_pagamento2.jpg}
...
\includegraphics{images/np1/92-loja_virtual_meio_de_pagamento3.jpg}

Ative esse tipo de meio-de-pagamento.

\includegraphics{images/np1/93-loja_virtual_meio_de_pagamento_personalizado.jpg}

Ative apenas a opção ``A combinar'' (referente a fazer a conferência de pagamento manualmente).

\includegraphics{images/np1/94-loja_virtual_meio_de_pagamento_personalizado_A_combinar.jpg}

\includegraphics{images/np1/95-loja_virtual_meio_de_pagamento_personalizado_A_combinar.jpg}

Pronto. Apenas confirme que seu meio de pagamento está configurado e ativado.

\includegraphics{images/np1/96-loja_virtual_meio_de_pagamento_personalizado_ativado.jpg}

\subsubsection{Simulação do comprador comprando uma camiseta}\label{simulauxe7uxe3o-do-comprador-comprando-uma-camiseta}

\includegraphics{images/np1/97-loja_virtual_iniciando_compra.jpg}

\includegraphics{images/np1/98-loja_virtual_iniciando_compra2.jpg}

\includegraphics{images/np1/99-loja_virtual_iniciando_compra3.jpg}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1169}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2857}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5974}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
\textbf{id}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
