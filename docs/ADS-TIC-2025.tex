...
\begin{quote}
Business Intelligence (BI) refere-se à \textbf{infraestrutura para coletar, armazenar, analisar e fornecer dados que podem ajudar os gerentes a tomar melhores decisões}. Essencialmente, BI transforma dados brutos em informações úteis e insights para apoiar a tomada de decisão organizacional. \textbf{{[}2{]} Ralph Kimball - Datawarehouse Toolkit (2013)}
\end{quote}
...
\begin{quote}
Data Warehouse (DW) não é simplesmente um repositório de dados, mas sim um sistema complexo cujo principal objetivo é apoiar a tomada de decisão gerencial - \textbf{{[}2{]} Ralph Kimball - Datawarehouse Toolkit (2013)}
\end{quote}
