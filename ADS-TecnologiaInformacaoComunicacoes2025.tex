...
\section{Parte Prática}\label{parte-pruxe1tica}

\subsection{Coletar dados do cliente:}\label{coletar-dados-do-cliente}
...
\section{Iniciar o cadastro no sistema ERP}\label{iniciar-o-cadastro-no-sistema-erp}

Comece inseriondo os dados do seu cliente no ERP

\includegraphics{01-bling-cadastro.jpg} \includegraphics{images/np1/02-bling-selecionar-area-comercial.jpg} \includegraphics{images/np1/03-bling-escolher-modulos-erp.jpg} \includegraphics{images/np1/04-bling-conta-criada.jpg} \includegraphics{images/np1/05-bling-logar-usuario-senha.jpg}

\subsection{Começar a cadastrar EMPRESA (Conceito de ``Módulo CONTROLE CADASTROS'' dos ERPs)}\label{comeuxe7ar-a-cadastrar-empresa-conceito-de-muxf3dulo-controle-cadastros-dos-erps}

\subsubsection{Começar a cadastrar a EMPRESA (pessoa física ou jurídica)}\label{comeuxe7ar-a-cadastrar-a-empresa-pessoa-fuxedsica-ou-juruxeddica}
...
\subsubsection{Começar a cadastrar as categorias dos produtos (pessoa física ou jurídica)}\label{comeuxe7ar-a-cadastrar-as-categorias-dos-produtos-pessoa-fuxedsica-ou-juruxeddica}
...
\subsubsection{Começar a cadastrar os produtos (pessoa física ou jurídica)}\label{comeuxe7ar-a-cadastrar-os-produtos-pessoa-fuxedsica-ou-juruxeddica}
...
\subsection{Começar a cadastrar o estoque (Conceito de ``Módulo CONTROLE DE ESTOQUE'' dos ERPs)}\label{comeuxe7ar-a-cadastrar-o-estoque-conceito-de-muxf3dulo-controle-de-estoque-dos-erps}
...
\subsection{Ative a LOJA FÍSICA (PDV)}\label{ative-a-loja-fuxedsica-pdv}
...
\subsection{Inicie a amarração do e-commerce com o ERP (começando no e-commerce)}\label{inicie-a-amarrauxe7uxe3o-do-e-commerce-com-o-erp-comeuxe7ando-no-e-commerce}
