...
| Vantagem / Sistemas de Informação | ERP | SCM | CRM |
|----|:--:|:--:|:--:|
...
2.  Sistemas de informações gerenciais (SIGs);

3.  Sistemas de apoio à decisão (SADs);

4.  Sistemas de apoio ao executivo (SAEs);

5.  **Sistemas integrados (ERP);**

6.  **Sistemas de gestão da cadeia de suprimentos (SCM);**

7.  **Sistemas de gestão do relacionamento com o cliente (CRM);**

8.  **Sistemas de gestão do conhecimento (SGCs);**
