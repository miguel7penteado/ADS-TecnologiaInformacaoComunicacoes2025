...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5492}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4508}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7163}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2837}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Software de Produtividade} são ferramentas para criação de documentos, planilhas, apresentações, e-mail (ex: Microsoft Office, Google Workspace). & \includegraphics{images/InfraEstrutura/software/MS-Office.jpg} \\
\end{longtable}

\subsubsection{Softwares de Segurança}\label{softwares-de-seguranuxe7a}

\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.6354}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.3646}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Software de Gerenciamento de Rede} é uma categoria deferramentas para monitorar e gerenciar a infraestrutura de rede. & \includegraphics{images/InfraEstrutura/software/monitoramento.jpg} \\
\end{longtable}
...
\begin{minipage}[t]{\linewidth}\raggedright
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4468}}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5532}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Tipo de MiddleWare
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5662}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4338}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4330}}
  >{\centering\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5670}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
...
\includegraphics{images/InfraEstrutura/ITIL/10-Gestao_Financeira_servicos_TI.jfif}
...
O Modelo Conceitual Entidade-Relacionamento (MER), proposto por Peter Chen em 1976, é uma ferramenta fundamental na modelagem de dados.

É um modelo de dados de alto nível que descreve a estrutura conceitual de um banco de dados.
